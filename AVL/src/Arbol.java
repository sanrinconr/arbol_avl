...
public class Arbol {
    ...
    public void insertar(int llave){
        insertar(llave,null,null,null,raiz);
    }
    ...
    private Nodo Reemplazar(Nodo A,Nodo buscado,boolean estado){
     if(estado==true){
         Reemplazar(A.derecha,buscado,false);
         if(nuevaRaiz!=null && nuevaRaiz.hashCode()!=raiz.hashCode())
         {
           A.derecha=nuevaRaiz;
           nuevaRaiz=null;
         ...
         if(Aux2.hashCode()!=buscado.derecha.hashCode()){
            Aux2.derecha=buscado.derecha; buscado.derecha=null;
         }else{buscado.derecha=null;}
        ...
        if(A.izquierda==null){
            ...
            Reemplazar(A.izquierda,buscado,estado);
            if(nuevaRaiz!=null && nuevaRaiz.hashCode()!=raiz.hashCode())
            {
                A.izquierda=nuevaRaiz;
                nuevaRaiz=null;
